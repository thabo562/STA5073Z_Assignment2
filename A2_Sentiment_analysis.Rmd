...
trigrams_sep %>%
  ...
  coord_flip() +
  xlab('') +
  labs(title = "Top 20 Positive Trigrams", caption = "Figure 1: Top 20 Positive Trigrams Overall") +  # Add a title and figure legend
...
trigrams_sep %>%
  ...
  coord_flip() +
  xlab('') +
  labs(title = "Top 20 Negative Trigrams", caption = "Figure 2: Top 20 Negative Trigrams Overall") +  # Add a title and figure legend
  scale_fill_viridis(discrete = TRUE) +
  theme(legend.position = "none")  # Remove the legend
...
trigrams_sep %>%
  ...
  labs(title = "Top 20 Positive Trigrams per President", caption = "Figure 3: Top 20 Positive Trigrams per President") +  # Add a title and figure legend
  scale_fill_viridis(discrete = TRUE) +
  theme(legend.position = "none")  # Remove the legend
...
trigrams_sep %>%
  ...
  xlab('') +
  facet_wrap(~president_13, scales = 'free') +
  labs(title = "Top 20 Negative Trigrams per President", caption = "Figure 4: Top 20 Negative Trigrams per President") +  # Add a title and figure legend
  scale_fill_viridis(discrete = TRUE) +
  theme(legend.position = "none")  # Remove the legend
...
trigrams_sep %>%
  ...
  labs(title = "Top 10 Positive Trigrams per Year", caption = "Figure 5: Top 10 Positive Trigrams per Year") +  # Add a title and figure legend
  scale_fill_viridis(discrete = TRUE) +
  theme(legend.position = "none")  # Remove the legend
...
trigrams_sep %>%
  ...
  xlab('') +
  facet_wrap(~year, scales = 'free') +
  labs(title = "Top 5 Negative Trigrams per Year", caption = "Figure 6: Top 5 Negative Trigrams per Year") +  # Add a title and figure legend
  scale_fill_viridis(discrete = TRUE) +
  theme(legend.position = "none")  # Remove the legend
...
ggplot(filter(sentiments_per_year, net_sentiment != '0'), aes(x = year, y = n, fill = net_sentiment)) +
  geom_col() +
  labs(title = "Sentiment Distribution per Year", caption = "Figure 7: Sentiment Distribution per Year")  # Add a title and figure legend
...
ggplot(filter(sentiments_per_year_overall, sentiment_category != 'neutral'), aes(x = year, y = n, fill = sentiment_category)) +
  geom_col() +
  labs(title = "Sentiment Distribution per Year", caption = "Figure 8: Sentiment Distribution per Year")  # Add a title and figure legend
```
```{r, echo=F}
sentiments_per_year %>%
  group_by(year) %>%
  ...
  geom_line() +
  geom_smooth() +
  labs(title = "Proportion of Negative Sentiment per Year", caption = "Figure 9 Proportion of Negative Sentiment per Year")  # Add a title and figure legend
...
ggplot(filter(sentiments_per_year_overall, sentiment_category != "neutral"), aes(x = year, y = freq, colour = sentiment_category, group = 1)) +
  ...
  labs(title = "Sentiment Distribution Over Time", caption = "Figure 10: Sentiment Distribution Over Time")  # Add a title and figure legend
...
ggplot(filter(sentiments_per_president, sentiment_category != 'neutral'), aes(x = year, y = n, fill = sentiment_category)) +
  ...
  labs(title = "Net Sentiment Analysis per President", x = "Year", y = "Count", caption = "Figure 11: Net Sentiment Analysis per President") +  # Add a title and figure legend
...
ggplot(filter(sentiments_per_president, sentiment_category != 'neutral'), aes(x = president_13, y = n, fill = sentiment_category)) +
  ...
  labs(title = "Net Sentiment Analysis per President", x = "President", y = "Count", caption = "Figure 12: Net Sentiment Analysis per President") +  # Add a title and figure legend
  scale_fill_manual(values = c("positive" = "blue", "negative" = "red")) +
...
ggplot(sentiments_per_speech, aes(x = filename, y = positive_proportion)) +
  ...
  labs(title = "Proportions of Positive and Negative Sentiments per Speech", x = "Year", y = "Proportion", caption = "Figure 14: Proportions of Positive and Negative Sentiments per Speech") +  # Add a title and figure legend
