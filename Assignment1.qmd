...
```{r}
#| fig-cap: "Top 5 bigrams related to negative sentiments"
...
a<- trigrams_sep %>%
  ...
  coord_flip() +
  xlab('') +
  labs(title = "Top 5 Positive Trigrams", caption = "Figure 1: Barplot Showing the 10 Most Frequently Used Positive Trigrams Overall") +  # Add a title and figure legend
...
b<- trigrams_sep %>%
  ...
  coord_flip() +
  xlab('') +
  labs(title = "Top 5 Negative Trigrams", caption = "") +  # Add a title and figure legend
  scale_fill_viridis(discrete = TRUE) +
  theme(legend.position = "none")  # Remove the legend
