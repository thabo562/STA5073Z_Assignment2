...
# calc net sentiment
trigrams_sep <- trigrams_sep %>%
  mutate(net_sentiment = (sentiment1 == 'positive') + (sentiment2 == 'positive')+(sentiment3 == 'positive') - 
           (sentiment1 == 'negative') - (sentiment2 == 'negative') - (sentiment3 == 'negative')) %>%
...
# Calculate net sentiment for trigrams in each tweet
...
ggplot(sentiments_per_speech, aes(x = year, y = average_positive_sentiment, fill = filename)) +
