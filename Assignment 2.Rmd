...
df_bigrams %>% filter(sentiment == "negative" & president_13 == "Mandela")%>%
  ...
  ggtitle("Mandela: Top 5 negative bigrams")
...
df_bigrams %>% filter(sentiment == "negative" & president_13 == "Mbeki")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("Mbeki: Top 5 negative bigrams")
...
df_bigrams %>% filter(sentiment == "negative" & president_13 == "Ramaphosa")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("Ramaphosa: Top 5 negative bigrams")
...
df_bigrams %>% filter(sentiment == "negative" & president_13 == "Zuma")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("Zuma: Top 5 negative bigrams")
...
df_bigrams %>% filter(sentiment == "negative" & president_13 == "deKlerk")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("deKlerk: Top 5 negative bigrams")
...
df_bigrams %>% filter(sentiment == "negative" & president_13 == "Motlanthe")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("Motlanthe: Top 5 negative bigrams")
...
df_bigrams %>% filter(sentiment == "positive" & president_13 == "Mandela")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("Mandela: Top 5 positive bigrams")
...
df_bigrams %>% filter(sentiment == "positive" & president_13 == "Mbeki")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("Mbeki: Top 5 positive bigrams")
...
df_bigrams %>% filter(sentiment == "positive" & president_13 == "Ramaphosa")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("Ramaphosa: Top 5 positive bigrams")
...
df_bigrams %>% filter(sentiment == "positive" & president_13 == "Zuma")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("Zuma: Top 5 positive bigrams")
...
df_bigrams %>% filter(sentiment == "positive" & president_13 == "deKlerk")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("deKlerk: Top 5 positive bigrams")
...
df_bigrams %>% filter(sentiment == "positive" & president_13 == "Motlanthe")%>%
  ...
  ggplot(aes(reorder(bigram,n),n, fill=bigram)) + 
  geom_col() + coord_flip() + xlab('')+
  ggtitle("Motlanthe: Top 5 positive bigrams")
...
beta_spread %>%
  ...
  coord_flip()+
  ggtitle("Mandela: beta values for topic 1 vs topic 2")
...
beta_spread %>%
  ...
  labs(y = 'Log2 ratio of beta in topic 2 / topic 1') +
  coord_flip()+
  ggtitle("Mbeki: beta values for topic 1 vs topic 2")
...
beta_spread %>%
  ...
  labs(y = 'Log2 ratio of beta in topic 2 / topic 1') +
  coord_flip()+
  ggtitle("Ramaphosa: beta values for topic 1 vs topic 2")
...
beta_spread %>%
  ...
  labs(y = 'Log2 ratio of beta in topic 2 / topic 1') +
  coord_flip()+
  ggtitle("Zuma: beta values for topic 1 vs topic 2")
...
beta_spread %>%
  ...
  labs(y = 'Log2 ratio of beta in topic 2 / topic 1') +
  coord_flip()+
  ggtitle("Motlanthe: beta values for topic 1 vs topic 2")
...
beta_spread %>%
  ...
  labs(y = 'Log2 ratio of beta in topic 2 / topic 1') +
  coord_flip()+
  ggtitle("deKlerk: beta values for topic 1 vs topic 2")
```


## 5.3.1 LDA Topic modelling for historical years

### 5.3.1 1994 - Abolishment of Apartheid
...
### 5.3.2. 1996 - South African consititution adopted by assembly
...
### 5.3.3. 2010 South African Soccer world cup
...
### 5.3.3. 2019 - start of Covid-19 pandemic
